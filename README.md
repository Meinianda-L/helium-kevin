...
If you want the old `init` flow in one place, run these steps:

1. Check Node.js is installed with `node --version`
2. Run `npm install`
3. Copy `.env.example` to `.env` if you do not have one yet
